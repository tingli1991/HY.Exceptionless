...
namespace Stack.Exceptionless
{
    ...
    public class ExceptionsLess
    {
        ...
        public static void Submit(string message, params string[] tags)
        {
        ...
        /// <param name="tags">标签</param>
        public static void Submit(string message, List<ExcDataParam> datas, params string[] tags)
        {
        ...
        /// <param name="data">自定义数据</param>
        /// <param name="tags">标签</param>
        public static void Submit(string message, ExcUserParam user, ExcDataParam data, params string[] tags)
        {
        ...
        private static IEnumerable<string> GetStackTraceList()
        {
            ...
            foreach (var trace in traceStringList)
            {
                ...
                if (!string.IsNullOrEmpty(traceTrimStr) && trace.LastIndexOf(@"Stack.Exceptionless\ExceptionsLess.cs") < 0
