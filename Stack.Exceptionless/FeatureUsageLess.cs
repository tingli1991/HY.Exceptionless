using Exceptionless;
using Stack.Exceptionless.Common;
...
namespace Stack.Exceptionless
{
    ...
    public class FeatureUsageLess
    {
        ...
        public static void Submit(string feature, params string[] tags)
        {
        ...
        /// <param name="data">自定义数据</param>
        /// <param name="tags">标签</param>
        public static void Submit(string feature, ExcDataParam data, params string[] tags)
        {
        ...
        /// <param name="tags">标签</param>
        public static void Submit(string feature, List<ExcDataParam> datas, params string[] tags)
        {
        ...
        /// <param name="data">自定义数据</param>
        /// <param name="tags">标签</param>
        public static void Submit(string feature, ExcUserParam user, ExcDataParam data, params string[] tags)
        {
        ...
        /// <param name="datas">自定义数据</param>
        /// <param name="tags">标签</param>
        public static void Submit(string feature, ExcUserParam user, List<ExcDataParam> datas, params string[] tags)
        {
            EventBuilder builder = ExceptionlessManager.Instance.ToFeatureUsageLess(feature)
               .AddTags(tags)
