...
namespace Stack.Exceptionless
{
    ...
    public class BrokenLinksLess
    {
        ...
        public static void Submit(string resource, params string[] tags)
        {
        ...
        /// <param name="data">自定义数据</param>
        /// <param name="tags">标签</param>
        public static void Submit(string resource, ExcDataParam data, params string[] tags)
        {
        ...
        /// <param name="tags">标签</param>
        public static void Submit(string resource, List<ExcDataParam> datas, params string[] tags)
        {
        ...
        /// <param name="datas">自定义数据</param>
        /// <param name="tags">标签</param>
        public static void Submit(string resource, ExcUserParam user, List<ExcDataParam> datas, params string[] tags)
        {
            EventBuilder builder = ExceptionlessManager.Instance.ToNotFound(resource)
               .AddTags(tags)
